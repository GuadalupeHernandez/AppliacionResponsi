...
Course.create name: 'Smartphone', description:'Um smartphone novo ...', status: :active, price: 10
Course.create name: 'Tablet', description:'Um tablet novo ...', status: :active, price: 20
...
Client.create name: 'Paulo', document: '1234', email: 'paulo@google.com', user: User.first
Client.create name: 'Julia', document: 'abcd', email: 'julia@google.com', user: User.first
